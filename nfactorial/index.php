...
<head>
    ...
    <title>Копия новостей Казахстана - Tengrinews.kz</title>
    ...
    <main>
        ...
        <div class="menu flex container">
            <div class="menu-nav flex container">
                <a href="http://localhost/nfactorial/"><img src="assets/long-logo-small.svg" alt="logo_long" ></a>
            ...
            <?php foreach ($all_news as $row): ?>
                <div class="card">
                    <div class="card-header">
                        <img src="<?php echo $row["photo_url"]; ?>" alt="news-image">
                    </div>
                    <div class="card-content">
                        <a id="<?php echo $row["news_id"]; ?>" href="article.php?id=<?php echo $row["news_id"]; ?>">
                            <h3><?php echo $row["title"]; ?></h3>
                            <div class="add-info flex">
                                <div class="flex">
                                    <p><?php echo $row["publication_date"]; ?></p>
                                </div>
                                <div class="flex">
                                    <img src="assets/icons/viewings.svg" alt="view-icon" id="view-icon">
                                    <p><?php echo $row["views_count"]; ?></p>
                                </div>
                                <div class="flex">
                                    <img src="assets/icons/comments.svg" alt="comment-icon" id="comment-icon">
                                    <p><?php echo $row["comments_count"]; ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
